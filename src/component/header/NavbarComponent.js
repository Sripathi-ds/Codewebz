...
function ResponsiveAppBar() {
    ...
    return (
        <div> 
            <Container >
            <AppBar position="static" sx={{ mt: 2, borderRadius: 50, backgroundColor: '#fff' }}>
                <Container maxWidth="xl">
                    <Toolbar disableGutters >
                        <AdbIcon sx={{ display: { xs: 'none', md: 'flex' }, color: '#0E1424', mr: 1 }} />
                        <Typography
                            variant="h6"
                            noWrap
                            component="a"
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                            ...
                            >
                                ...
                                <MenuItem>
                                    <Button variant="contained" sx={{ borderRadius: 50, backgroundColor: '#3f3eed', textTransform: 'capitalize' }}>Login / Signup</Button>
                                </MenuItem>

                            </Menu>
                        </Box>
                        <AdbIcon sx={{ display: { xs: 'flex', md: 'none' }, color: '#0E1424', mr: 1 }} />
                        <Typography
                            variant="h5"
                            noWrap
                            component="a"
